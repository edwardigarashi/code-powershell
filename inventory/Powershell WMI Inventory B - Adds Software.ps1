...
# 
# NAME: Server/Workstation Inventory 
# 
# AUTHOR: 
# DATE  : 4/3/2013
...
# ========================================================================
# Example Alteration for Software
# ========================================================================
#You can use wmi class win32_Software in the very same way You use other classes with this script
 
# Get-WmiObject win32_Software -computername $strComputer
# but this is rather slow, faster would be to use registry
# I use this function to get list of software
...
#		Get-ItemProperty | 
#		Select-Object displayName,displayVersion, @{L='Guid';E={Split-Path $_.PSPath -Leaf}}
#	}
 
#	it works locally but You can run this command remotely using Invoke-Command
# You can also use remoteregistry
 
# Example of how to get particular data:
 		# $Reg = [Microsoft.Win32.RegistryKey]::OpenRemoteBaseKey('LocalMachine', $ComputerName)
		# $Reg.OpenSubKey('Software\Microsoft\Windows\Uninstall\appname').GetValue('something') 